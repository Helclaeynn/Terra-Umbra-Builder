...
import {manualArticleMedia} from './manual-media.js?v=20260918-bulk1';
...
function articleMedia(a){
  ...
  const media=editorialMedia??manualArticleMedia(a.id)??a.illustration??a.image;
