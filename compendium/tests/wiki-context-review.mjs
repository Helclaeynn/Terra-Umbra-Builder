...
const risky=new Set(['cycle','corruption','chasseur','chasseurs','fleau','fleaux','revelation','revele','revelee','voile','nature','eveil','se reveler','terre','commission','gang','gangs','la famille','grande reserve','la grande reserve','autres factions','grands ensembles','civil ordinaire','grand felin','chien noir']);
