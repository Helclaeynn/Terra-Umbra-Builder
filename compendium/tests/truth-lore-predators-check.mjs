...
console.log(`LORE PRÉDATEURS V6 OK — corpus Vérité ${truth.length} · hubs Vampire/Garou reconstruits · cultures vampiriques + Sangs noirs + 6 Pelages book-first · lore consolidé ${legacy.length}.`);
