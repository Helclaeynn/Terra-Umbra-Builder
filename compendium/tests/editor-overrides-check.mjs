...
const base={id:'demo-1',title:'Ancien titre',source:'source.docx',status:'source_detaillee',tags:['A'],sections:[{id:'s1',title:'Section',level:3,blocks:[{type:'p',text:'Texte'}]}],pnj:{age:'42'}};
...
edited.pnj.portrait='images/demo.webp';
...
console.log(`Editor override engine OK: ${diff.length} opérations de test.`);
