...
const hierarchical=['Règles','Réalité','Vérité','Équipement','Augmentations','Organisations','Personnages','Bestiaire','Catalogue Vérité'];
...
console.log('CATEGORY NAVIGATION RUNTIME OK — 9 catégories hiérarchiques, cartes clonées/cliquables, filtre rebouclé.');
