...
const hierarchical=['Règles','Réalité','Vérité','Équipement','Augmentations','Bestiaire','Catalogue Vérité'];
...
console.log('CATEGORY NAVIGATION RUNTIME OK — 7 catégories hiérarchiques, cartes clonées/cliquables, filtre rebouclé.');
