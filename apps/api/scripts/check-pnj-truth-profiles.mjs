...
assert.equal(new Set(INDIVIDUALLY_REVIEWED_TRUTH_PNJ_IDS).size,305);
...
for(const id of [...REVIEWED_TRUTH_BATCH_001_IDS,...REVIEWED_TRUTH_BATCH_002_IDS,...REVIEWED_TRUTH_BATCH_003_IDS]){
