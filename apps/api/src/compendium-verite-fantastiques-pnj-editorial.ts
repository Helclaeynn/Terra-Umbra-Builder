...
const DECISIONS: Record<string, EditorialDecision> = {
  ...
  "personnages-verite-fantastiques-theoderid": { publicTitle: "Theoderid", mjOnly: true },
  ...
  "personnages-verite-fantastiques-tharlal-rark": { publicTitle: "Thar’lal Rark", mjOnly: true },
