  ...
  "lore": [
    {
      ...
      "blocks": [
        {
          "type": "p",
          "text": "« La mer porte leur mémoire. La foudre porte leur voix. »"
        }
      ]
    },
    {
  ...
  "r1": [
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "p",
          "text": "Tous les Aseryns comprennent l'Accelyr, une langue parlée à une vitesse que l'oreille et le cerveau humains ne peuvent normalement pas suivre. L'Accelyr ne donne aucun bonus chiffré par lui￾même ; il permet surtout une communication extrêmement rapide entre Aseryns et sert souvent de signe de reconnaissance culturelle."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "type": "p",
          "text": "• R: +2 Agi, +1 Vol Orientation: Affinité magique, lecture des flux Mûlien SR: +1 Agi, +1 Esp",
          "style": "list"
        },
        {
          "type": "p",
          "text": "• R: +2 Agi, +1 Esp Orientation: Psychisme, télépathie Hyperboréen SR: +1 Agi, +1 Vig",
          "style": "list"
        },
        {
          "type": "p",
          "text": "• R: +2 Agi, +1 Vig Orientation: Physique, endurance, explosivité Lémurian SR: +1 Agi, +1 Vol",
          "style": "list"
        },
        {
          "type": "p",
          "text": "• R: +2 Agi, +1 Vol Orientation: Héritage nymphal et élémentaire Serathèen SR: +1 Agi",
          "style": "list"
        },
        {
          "type": "p",
          "text": "• R: +2 Agi Orientation: Ascendance composite, Traces multiples Aérilien / Néo-Atlante",
          "style": "list"
        }
      ]
    },
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "p",
          "text": "SR : +1 Agilité. R : +2 Agilité. Le Serathèen ne reçoit pas de troisième modificateur d'Attribut : sa force est sa plasticité d'ascendance et de formation."
        }
      ]
    },
    {
  ...
  "r2": [
    {
      ...
      "blocks": [
        {
          "type": "p",
          "text": "Quatorze enfants reçurent autrefois une stèle et une mission. Kalirath fut ensuite rejeté et ne resta pas parmi les Fondateurs ; la tradition historique retient donc les Treize."
        },
        {
          "type": "p",
          "text": "Les Traditions ne sont pas des lignées génétiques ni des droits attachés à un nom de famille. Elles représentent des savoirs et disciplines culturels hérités des fonctions des Fondateurs. Un Aseryn n'a pas besoin de porter le nom de la Maison correspondante pour apprendre une Tradition."
        },
        {
          "type": "p",
          "text": "Les Traditions ordinaires sont cumulables. Il n'existe ni taxe générique d'ouverture ni limite numérique arbitraire. En revanche, chaque Tradition exige une véritable formation fictionnelle : Maison, communauté, maître, institution ou apprentissage crédible. Dépenser des PTV représente la maîtrise acquise, pas l'achat d'un enseignement sorti de nulle part."
        },
        {
          "type": "p",
          "text": "Tous les Fondateurs savaient manier la Foudre à des degrés divers. Cela ne transforme pas leurs Traditions en écoles de Foudre : Dratyn avait précisément pour devoir de préserver et transmettre cette discipline."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "p",
          "text": "Theana est la Fondatrice. Theanai désigne la Maison/lignée moderne."
        },
        {
          "type": "p",
      ...
      "blocks": [
        {
          ...
          "rows": [
            ...
            [
              "État requis",
              "La génération de Foudre exige normalement R. Conduction peut fonctionner en SR/R."
            ],
            [
              "Activation d’une attaque",
              "1 PA sauf Talent contraire."
            ],
            [
              "Jet de Foudre",
              "Volonté + Maîtrise spirituelle + 1d10e contre la Défense pertinente."
            ],
            [
              "Résolution",
              "Dégâts = Marge de réussite + DGT − Protection électrique applicable."
            ],
            [
              "Portée normale",
              "20 m."
            ...
            [
              "Armure conventionnelle",
              "Kevlar, plaques, armure de combat ordinaire : aucune réduction contre la Foudre."
            ],
            [
              "Protection pertinente",
              "Isolation électrique réelle, cage de Faraday, équipement conçu pour canaliser la décharge ou protection surnaturelle adaptée."
            ],
            [
              "Paliers de Tir",
              "Ne s’appliquent pas. Pas de double DGT ni d’Altération automatique à marge 6/11."
            ],
            [
              "Foudre aseryne",
              "DGT 7."
        ...
        {
          "type": "p",
          "text": "Une armure métallique n'augmente pas automatiquement les dégâts : elle ne protège simplement pas, sauf si sa conception lui donne une véritable fonction électrique."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "p",
          "text": "Profil Accès Serathèen issu du Conseil Naturel : son milieu culturel peut justifier directement la formation. Autre Serathèen Ouvert : nécessite accueil et enseignement réel. Aseryn d’une autre Origine Ouvert ou Restreint selon le contexte ; aucun verrou biologique absolu. Les Voies du Conseil sont cumulables. L'accès aux spectres dépend aussi du lieu, des liens avec la communauté et de la coopération des Ancêtres."
        }
      ]
    },
    {
