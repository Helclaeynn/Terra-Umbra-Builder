...
export function applyCompendiumPnjRepairs(byId:Map<string,A>){
  ...
  const relZaihra=article(byId,["Zaihra al-Fatti"]);if(relZaihra)replace(relZaihra,[[/aux Etats-Unis/gi,"aux États-Unis"],[/et risque sa vie/gi,"et risqua sa vie"],[/attisaient la haines/gi,"attisaient la haine"],[/il y eu un conflit/gi,"il y eut un conflit"],[/courage exemplaire pur faire progresser/gi,"courage exemplaire pour faire progresser"]]);
  const relYasmina=article(byId,["Yasmina El Khayat"]);if(relYasmina)replace(relYasmina,[[/son ainé/gi,"son aîné"],[/tête brulée/gi,"tête brûlée"],[/aventures malsaine/gi,"aventures malsaines"],[/un soutient solide/gi,"un soutien solide"]]);
  const relBhima=article(byId,["Bhima Shiravadakar"]);if(relBhima)replace(relBhima,[[/n’avait à cœur que respecter/gi,"n’avait à cœur que de respecter"],[/plus fortes que ma majorité/gi,"plus fortes que la majorité"],[/de communauté en communautés/gi,"de communauté en communauté"],[/énormément de brahmane s’alignèrent/gi,"énormément de brahmanes s’alignèrent"],[/les chaines de télévisions/gi,"les chaînes de télévision"]]);
  const relDurgawati=article(byId,["Durgawati Ghandi"]);if(relDurgawati)replace(relDurgawati,[[/Née en inde/gi,"Née en Inde"],[/bien qu’elle se fit aussi placer/gi,"bien qu’elle se fît aussi placer"],[/elle n’a jamais spécialement douée/gi,"elle n’a jamais été spécialement douée"],[/figure intournable/gi,"figure incontournable"],[/elle a réussi en quelques années\) retrouver/gi,"elle a réussi en quelques années à retrouver"],[/quelque chose de terrifiants/gi,"quelque chose de terrifiant"]]);
  const relHyotaru=article(byId,["Hyotaru Adashi"]);if(relHyotaru)replace(relHyotaru,[[/aux Etats-Unis/gi,"aux États-Unis"],[/menace Coréenne/gi,"menace coréenne"],[/se refusa de s’approcher/gi,"refusa de s’approcher"],[/et passé quelques années difficiles/gi,"et, après quelques années difficiles"],[/leurs cybertags marquant/gi,"leurs cybertags marquèrent"],[/ces pratiques, , ironiquement/gi,"ces pratiques, renforçant ironiquement"],[/Xieren fut obligée de revoir ses plans et mis en place/gi,"Xieren fut obligée de revoir ses plans et mit en place"],[/les fois californienne/gi,"les fois californiennes"],[/Dina page/gi,"Dina Page"]]);
  const relMordell=article(byId,["Mordell Lee Wildlake"]);if(relMordell)replace(relMordell,[[/grandes boites américaine sen quelques années/gi,"grandes boîtes américaines en quelques années"],[/porte-parole de byron industries corporation/gi,"porte-parole de Byron Industries Corporation"],[/devant le publique/gi,"devant le public"],[/grave erreur à le sous-estimer/gi,"grave erreur en le sous-estimant"],[/clips de campagnes ou de publicité/gi,"clips de campagne ou de publicité"],[/religieux Chrétiens/gi,"religieux chrétiens"],[/traces habituelles même discrète/gi,"traces habituelles, même discrètes"]]);
  const relAmaya=article(byId,["Amaya Carvallo"]);if(relAmaya)replace(relAmaya,[[/le Primat CARVALLO était un Cadre/gi,"le primat CARVALLO était une cadre"],[/l’ont mené au conseil/gi,"l’ont menée au conseil"],[/le réseau qu’apporte ses membres/gi,"le réseau qu’apportent ses membres"],[/plus un membre est riche plus il sera assez vite haut placé/gi,"plus un membre est riche, plus il sera rapidement haut placé"],[/d’une grand et lourde poitrine/gi,"d’une grande et lourde poitrine"],[/ou sans jambe/gi,"ou sans jambes"]]);
  const relSigrid=article(byId,["Sigrid Jorgensen"]);if(relSigrid)replace(relSigrid,[[/s’est toujours passionnées/gi,"s’est toujours passionnée"],[/les cotes norvégiennes/gi,"les côtes norvégiennes"],[/de telles catastrophe/gi,"de telles catastrophes"],[/elle se ru en Californie/gi,"elle se rua en Californie"],[/des grandes inondations allant avec/gi,"des grandes inondations qui l’accompagnèrent"],[/le nombre de conscrit/gi,"le nombre de conscrits"],[/les religions abrahamiques, au contraire que ces dernières leur devant tout/gi,"les religions abrahamiques, estimant au contraire que ces dernières leur devaient tout"],[/pour les reconnaitre/gi,"pour les reconnaître"]]);
  const relCiara=article(byId,["Ciara McFarlane","Ciara MacFarlane"]);if(relCiara)replace(relCiara,[[/le bikers des BCMC/gi,"les bikers des BCMC"],[/d’origine irlandaise et écossaises/gi,"d’origine irlandaise et écossaise"],[/en faisan chasseuse de prime/gi,"en faisant la chasseuse de primes"],[/aux Etats-Unis/gi,"aux États-Unis"],[/le nombre de conscrit pour la guerre/gi,"le nombre de conscrits pour la guerre"],[/n’estimant pas que l’esprit et l’âme humaine ne le supportent bien/gi,"estimant que l’esprit et l’âme humaine ne le supportent pas bien"]]);
  const relJack=article(byId,["Jack Kaufmann"]);if(relJack)replace(relJack,[[/une bombe posé par son équipe/gi,"une bombe posée par son équipe"],[/il fut rapatrié et resta paralysé depuis/gi,"il fut rapatrié et en resta paralysé"],[/se fit connaitre/gi,"se fit connaître"],[/Quand la rumeur d’un paradis virtuel se fit connaitre/gi,"Quand la rumeur d’un paradis virtuel se fit connaître"],[/il relégua chaque information dessus et traquant/gi,"il relaya chaque information à son sujet et traqua"],[/En 2033, il fondit de grands sites Holonets/gi,"En 2033, il fonda de grands sites Holonet"],[/la Santé publique/gi,"la santé publique"]]);
  const relMeina=article(byId,["Meina Korgovski"]);if(relMeina)replace(relMeina,[[/New-York/gi,"New York"],[/aux Etats-Unis/gi,"aux États-Unis"],[/elle y parvint à faire carrière dans la musique, la DJ produisant et réalisant des musiques électroniques/gi,"elle y parvint à faire carrière dans la musique, produisant et réalisant des morceaux électroniques comme DJ"],[/Moins apprécié, son style/gi,"Peu apprécié, son style"],[/sa crise artistique tomba avec la guerre/gi,"sa crise artistique coïncida avec la guerre"],[/grâce à l’holonet/gi,"grâce à l’Holonet"],[/religion Elyséiste/gi,"religion élyséiste"],[/tendances psychopathes, Contrairement/gi,"tendances psychopathes. Contrairement"]]);
  const relLevey=article(byId,["Levey Uriel"]);if(relLevey)replace(relLevey,[[/levey s’orienta/gi,"Levey s’orienta"],[/quelques temps/gi,"quelque temps"],[/affaires d’état/gi,"affaires d’État"],[/apprenant pour devenir rabbin/gi,"étudiant pour devenir rabbin"],[/d’une ingérences/gi,"d’une ingérence"],[/accueillir plus de réfugiées/gi,"accueillir davantage de réfugiés"],[/fut surtout forcé de défendre malgré son âge, à l’époque 62 ans, les bénévoles/gi,"dut surtout défendre les bénévoles malgré son âge, alors 62 ans"],[/fit un tour des états suite son élection/gi,"fit un tour des États à la suite de son élection"],[/guerres corporatiste/gi,"guerres corporatistes"]]);
  const relElishevah=article(byId,["Elishevah Yarom-Smith"]);if(relElishevah)replace(relElishevah,[[/révélation divine qu’elle avait eu/gi,"révélation divine qu’elle avait eue"],[/On ignore sur le choix des rabbins a été réellement son nom/gi,"On ignore si le choix des rabbins s’est réellement porté sur son nom"],[/crie à la trahison et être le seul vrai Grand-rabbin/gi,"crie à la trahison et affirme être le seul vrai Grand-rabbin"],[/qu’elle soit grandement à l’aise en public/gi,"qu’elle soit très à l’aise en public"],[/diner hebdomadaires/gi,"dîners hebdomadaires"]]);
  const xi=article(byId,["Xieren Song"]);if(xi){xi.pnj={...(xi.pnj??{}),statut:"Grande figure shientaoïste californienne"};setTable(xi,"Statut","Grande figure shientaoïste californienne");setTable(xi,"Fonction / désignation","Grande figure shientaoïste californienne");replace(xi,[[/aux Etats-Unis/gi,"aux États-Unis"],[/un immense riche expatrié/gi,"un très riche expatrié"],[/elle la patronne d’une immense multinationale/gi,"la patronne d’une immense multinationale"],[/vendre se sociétés/gi,"vendre ses sociétés"],[/sa retraite en chine/gi,"sa retraite en Chine"],[/et plus tard cette du Shientaoïsme/gi,"et plus tard celle du Shientaoïsme"],[/qui n’ayant pas d’Institution/gi,"qui, n’ayant pas d’institution"],[/petit à petit celle religion/gi,"petit à petit cette religion"],[/racistes des asiatiques/gi,"racistes envers les Asiatiques"]]);}
