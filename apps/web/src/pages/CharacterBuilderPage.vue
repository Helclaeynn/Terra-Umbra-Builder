...
.builder-v2-shell {
  background:
    radial-gradient(circle at 88% 4%, rgba(132, 96, 50, .07), transparent 30rem);
}
.builder-sidebar {
  border-color: var(--tu-border);
  background: linear-gradient(180deg, rgba(24,22,18,.94), rgba(15,14,12,.92));
  box-shadow: var(--tu-shadow);
}
.builder-character {
  border-bottom-color: var(--tu-border-soft);
  background:
    linear-gradient(135deg, var(--tu-gold-wash), transparent 72%);
}
.builder-progress {
  border-bottom-color: var(--tu-border-soft);
...
.builder-progress-track span {
  ...
  background: linear-gradient(90deg, var(--tu-gold-strong), var(--tu-gold-bright));
}
.builder-nav button {
...
.builder-nav button.active {
  border-left-color: var(--tu-gold);
  color: var(--tu-text);
  background: linear-gradient(90deg, rgba(169,132,76,.16), rgba(169,132,76,.035));
  box-shadow: inset 0 0 0 1px rgba(204,178,125,.07);
}
.builder-card {
  border-color: var(--tu-border);
  background:
    linear-gradient(145deg, rgba(27,24,20,.91), rgba(16,15,13,.88));
}
.schema-badge,
.references-button span {
  border-radius: 999px;
  border-color: rgba(204,178,125,.28);
...
.choice-card:hover {
  ...
  background: rgba(204,178,125,.035);
  box-shadow: 0 12px 28px rgba(0,0,0,.14);
}
.choice-card.selected {
  border-color: var(--tu-gold-strong);
  background: linear-gradient(145deg, rgba(169,132,76,.13), rgba(169,132,76,.055));
  box-shadow: inset 0 0 0 1px rgba(224,197,142,.05);
}
.subsection {
...
.knowledge-drawer {
  ...
  background: linear-gradient(180deg, #171511, #0e0d0b);
  box-shadow: -28px 0 86px rgba(0,0,0,.45);
}
.knowledge-head,
.knowledge-group {
