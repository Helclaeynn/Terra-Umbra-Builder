...
/* V1-inspired Compendium visual alignment */
.compendium-shell{
  background:
    radial-gradient(circle at 10% 0%,rgba(38,72,87,.24),transparent 34rem),
    radial-gradient(circle at 88% 18%,rgba(36,74,84,.10),transparent 28rem);
}
.compendium-topbar{
...
.compendium-stats strong{color:var(--tu-accent)}
.compendium-search{
  border-color:var(--tu-border);
...
.search-line input[type="search"]:focus{
  border-color:#456574;
...
.result-card.active{
  box-shadow:inset 3px 0 var(--tu-accent);
}
.result-card p,
.result-heading>span,
.empty-results,
...
.article-paragraph{color:#dce5ea}
.article-paragraph.lore{color:#c7d2d8}
.article-paragraph.list{border-left-color:#36505c}
.article-table td{border-color:var(--tu-border);color:#c7d2d8}
.wiki-edit-link{
  border-color:#36505c;
  color:var(--tu-accent);
  border-radius:9px;
...
.wiki-toc button{color:#9fb0ba}
.wiki-toc button:hover{color:var(--tu-accent)}
.wiki-builder-usage,
.talent-wiki-card{
  border-color:#28414a;
  background:#0e1a1d;
}
.wiki-builder-usage-list article{
  border-color:var(--tu-border);
  background:#0d141a;
}
.wiki-builder-usage-list article>span{color:var(--tu-accent)}
.wiki-related-grid button{
  border-color:var(--tu-border);
  border-radius:12px;
  background:#0e151b;
...
.wiki-related-grid span{color:var(--tu-accent)}
:deep(.wiki-link){
  color:var(--tu-accent2);
  text-decoration-color:rgba(115,168,255,.45);
}
:deep(.wiki-link:hover),
:deep(.wiki-link:focus-visible){
  color:#a7c7ff;
