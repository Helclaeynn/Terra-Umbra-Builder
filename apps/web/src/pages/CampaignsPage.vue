    ...
    <main>
      ...
      <template v-else-if="campaign">
        ...
        <template v-if="campaign.canManage||campaign.membershipStatus==='accepted'">
          ...
          <details v-if="campaign.canManage" class="panel" @toggle="toggleBestiary"><summary>Mon bestiaire de campagne · créateur et générateur</summary><CampaignBestiary v-if="bestiaryOpen" :campaign-id="id" :group-size="members.filter(m=>m.status==='accepted').length||4" :archived="!!campaign.archivedAt" @dirty="bestiaryDirty=$event" /></details>
