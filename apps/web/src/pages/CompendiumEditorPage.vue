...
.wiki-editor-shell {
  background:
    radial-gradient(circle at 84% 6%, rgba(142,102,52,.075), transparent 32rem);
}
.wiki-editor-topbar {
  border-bottom-color: var(--tu-border);
  background: linear-gradient(180deg, rgba(18,16,13,.97), rgba(11,10,9,.95));
...
.editor-card {
  background:
    linear-gradient(145deg, rgba(27,24,20,.92), rgba(16,15,13,.86));
}
.editor-card:hover {
...
.editor-preview-column {
  background:
    linear-gradient(145deg, rgba(25,23,19,.9), rgba(14,13,12,.9));
