...
.newcomer-hero{display:flex;align-items:flex-end;justify-content:space-between;gap:2rem;padding:1.4rem 1.5rem;border-color:rgba(157,124,72,.3);background:linear-gradient(135deg,rgba(157,124,72,.09),rgba(255,255,255,.018))}
.newcomer-hero h2{margin:.15rem 0 .45rem;font:500 clamp(1.8rem,3vw,2.8rem)/1.05 Georgia,serif}
.newcomer-hero p:not(.eyebrow){max-width:82ch;margin:0;color:#aaa296;line-height:1.6}
.newcomer-section{display:grid;gap:.8rem}.newcomer-section-head h3{margin:.15rem 0 0;font:500 clamp(1.35rem,2vw,1.8rem)/1.15 Georgia,serif}
...
.newcomer-card strong,.category-entry strong{font:500 1.15rem/1.2 Georgia,serif;color:#ddd4c6}
.newcomer-card p,.category-entry p,.nature-card p{color:#938b81;line-height:1.55;margin:.45rem 0}
.newcomer-card span{margin-top:auto;color:#c5a66f;font-size:.75rem;font-weight:700}
.newcomer-card:hover,.category-entry:hover,.nature-actions button:hover{border-color:rgba(157,124,72,.55)}
...
.nature-card>div:first-child{min-width:0}.nature-card strong{font-size:1rem;color:#d8d0c3}.nature-actions{display:flex;justify-content:flex-end;gap:.4rem;flex-wrap:wrap}
.nature-actions button{white-space:nowrap;border:1px solid rgba(255,255,255,.1);background:transparent;color:#aaa296;padding:.4rem .55rem}
.nature-title-row{display:flex;gap:.5rem;align-items:center;flex-wrap:wrap}.start-pill{padding:.2rem .45rem;border:1px solid rgba(181,139,77,.45);color:#dfbd80;font-size:.62rem;text-transform:uppercase;letter-spacing:.05em}
.restricted-title{margin:.7rem 0 0;color:#b89a69;font-size:.8rem;text-transform:uppercase;letter-spacing:.08em}
