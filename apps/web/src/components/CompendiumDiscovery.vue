...
@media(max-width:1200px){.discovery{--discovery-gutter:clamp(24px,3vw,36px)}.discovery-hero{min-height:500px;padding-top:40px;padding-bottom:28px}.discovery-content{padding-top:34px;padding-bottom:28px}.discovery-coordinates{display:none}.discovery-cards,.discovery-journeys{grid-template-columns:repeat(2,minmax(0,1fr))}.discovery-article:last-child,.discovery-journey:last-child{grid-column:1/-1}.discovery-guide-layout.has-illustration{grid-template-columns:1fr}.discovery-illustration{max-width:640px}.discovery-themes{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media(max-width:700px){.discovery{--discovery-gutter:20px}.discovery-hero{padding-top:34px;padding-bottom:26px;min-height:460px}.discovery-hero h1{font-size:clamp(2rem,8.5vw,3.25rem);line-height:1.1;margin:28px 0 22px}.discovery-hero-meta{padding-top:32px}.discovery-orbit{object-position:65% center}.discovery-hero:after{background:linear-gradient(90deg,#050c17e6,#050c1760),linear-gradient(0deg,#080f1a,transparent 50%)}.discovery-hero-copy{font-size:.9rem!important}.discovery-hero>.discovery-eyebrow{font-size:.67rem;letter-spacing:.07em}.discovery-content{padding-top:30px;padding-bottom:24px}.discovery-section{margin-top:36px}.discovery-layers,.discovery-cards,.discovery-journeys,.discovery-themes{grid-template-columns:1fr}.discovery-layer{min-height:180px;padding:24px}.discovery-layer p{max-width:85%}.discovery-article:last-child,.discovery-journey:last-child{grid-column:auto}.discovery-resume{padding:20px}.discovery-resume .discovery-secondary{width:100%}.discovery-heading>.discovery-eyebrow{font-size:.65rem}.discovery-guide-section,.discovery-steps>li{grid-template-columns:22px minmax(0,1fr);gap:10px;padding:21px 14px}.discovery-guide-section h2,.discovery-steps h2{font-size:1.3rem}.discovery-guide-copy>p,.discovery-steps li>div>p:not(.discovery-eyebrow){font-size:.95rem}.discovery-footer{font-size:.67rem}.discovery-primary,.discovery-secondary{font-size:.8rem}}
