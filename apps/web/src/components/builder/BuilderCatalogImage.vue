...
onMounted(observe);onUnmounted(()=>{alive=false;observer?.disconnect();});watch(()=>[props.articleId,props.name],()=>{src.value='';observe();});
</script>
...
<style scoped>.catalog-art{height:145px;display:grid;place-items:center;overflow:hidden;background:#0a1929;border:1px solid #30475e;border-radius:6px}.catalog-art img{height:100%;width:100%;object-fit:contain}.catalog-art span{font:600 22px/1 Inter,sans-serif;letter-spacing:.18em;color:#608094}@media(max-width:600px){.catalog-art{height:110px}}</style>
